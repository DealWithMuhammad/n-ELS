...
async function handler(req, res) {
    if (req.method === "POST") {
        const { submittedAt , fullNameStudent , dateOfBirth , gender , reTest , currentSchool , currentGrade , fullNameParent , relationship , occupation , company , phoneNumber , email , dateOfExam ,  } = req.body;
...
var __webpack_exports__ = (__webpack_exec__(4318));
