          ...
          >
            ...
            <p className="max-w-xl mt-4 text-lg leading-relaxed text-purple-800 md:mt-6">
              {f({
                ...
                defaultMessage:
                  "Since February 2017, ELS School is recognized as a Cambridge School by Cambridge International Examinations (CIE) - a leading organization that provides a variety of education programs and qualifications for international students from 5 to 19 years old.",
              })}
            </p>
            <br />
